...
app.listen(PORT, () => {
  console.log(`========================================================================`);
  console.log(`⛳ Unykorn Kiwi RWA Broker Server online on port ${PORT}`);
  console.log(`========================================================================`);
  ...
  // Launch the WebSocket Central Limit Order Book server on port 3398
  startWebSocketClobServer(3398);
});
